        ...
        <div class="master-wrapper">
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand smoothie logo" href="index.html"><img src="assets/img/logoN2.png" alt="logo"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="/allOrder">Commandes passées</a></li>
                                        <li><a href="/orderStatusActive">Commande active</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/idModif.jsp">Paramètres de sécurisation</a></li>
            ...
            <header id="headerwrap" class="backstretched fullheight">
                <div class="container vertical-center">
                    <div class="intro-text vertical-center text-left smoothie">
                        <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.2s">BookShop</div>
                        <div class="intro-sub-heading wow fadeIn secondary-font" data-wow-delay="0.4s">Des livres <span class="rotate">passionnants, rafraîchissants, séduisants</span>  à lire</div>
                    </div>
                </div>
            </header>


            <%-- Debut premiere ligne ${book.coverURL} ${bookBean.fullPriceText}${book.title}  ${book.subTitle}--%>
                            ...
                            <c:forEach var="book" items="${books}">
                                ...
                                <div class="col-md-4">
                                    <div class="hover-item mb30">
                                        <img src="${book.coverURL}" class="img-responsive smoothie" alt="">
                                        <div class="overlay-item-caption smoothie"></div>
                                        <div class="hover-item-caption smoothie">
                                            <div class="vertical-center smoothie">
                                                <a href="book?isbn=${book.isbn} " class="smoothie btn btn-primary">View</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item-excerpt">
                                        <h4 class="pull-right">${bookBean.fullPriceText} Euros</h4>
                    ...
                    <div class="flexpanel">
                        <div class="viewport-wrap">
                            ...
                            <div class="widget about-us-widget mb50">
                                <h4 class="widget-title">About BookShop</h4>
                                <p>Professionally monetize team building materials for 24/7 results. Holisticly transition corporate platforms vis-a-vis cutting-edge experiences. Dynamically strategize ubiquitous applications for premier initiatives. Interactively seize resource sucking niche markets.</p>
                            </div>
                        </div>
                    </div>
